...
!function (t) {
    ...
    e.prototype = {constructor: e, render: function () {
        ...
        r.length && this.$element.trigger("selected", {info: r}), i.trigger("updated", {info: r, item: i, eventType: o})
        ...
        return void 0 === r ? o : r
    }, t.fn.tree.defaults = {selectable: !0, multiSelect: !1, loadingHTML: "<div>Loading...</div>", cacheItems: !0}, t.fn.tree.Constructor = e
}(window.jQuery);