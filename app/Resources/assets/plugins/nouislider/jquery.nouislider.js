...
(function ($, UNDEF) {
    ...
    $.fn.noUiSlider = function (options) {
        ...
        // pushing to the array, which reduces '.addClass()' calls.
            , stdCls = {
                base: [clsList[0], clsList[13]], origin: [clsList[1]], handle: [clsList[2]]
            }
        ...
        if (window.navigator.msPointerEnabled) {
            actions = {
                start: 'MSPointerDown' + namespace, move: 'MSPointerMove' + namespace, end: 'MSPointerUp' + namespace
            };
        }
        ...
        function tap(event) {
            ...
            // This is a bug, as far as I can see, in IE(10?).
                ...
                , offset = {
                    handles: [], base: {
                        left: base.offset().left - correction.x, top: base.offset().top
                    }
                };
            ...
            for (i = 0; i < handles.length; i++) {
                offset.handles.push({
                    left: handles[i].offset().left - correction.x, top: handles[i].offset().top
                });
            }
            ...
            return this.each(function (index, target) {
                ...
                if (!options.serialization) {
                    options.serialization = {
                        to: [false, false], resolution: 0.01
                    };
                }
                ...
                base.data({
                    options: options, handles: handles, style: style
                });

                // Add a downstream reference to the target as well.
                target.data({
                    base: base, handles: handles
                });
