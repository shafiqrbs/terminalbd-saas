...
class Cart {
     ...
     */
    public function vat(){
        return $this->cart_contents['cart_vat'];
    }
    ...
    public function entityUpdate($data){
        // unset & save
        $this->cart_contents['cart_total'] = $data['total'];
        $this->cart_contents['cart_discount_percent'] = $data['discountPercent'];
        $this->cart_contents['cart_discount'] = $data['discount'];
        $this->cart_contents['cart_vat'] = $data['vat'];
        $this->save_cart();
        return TRUE;
    }
