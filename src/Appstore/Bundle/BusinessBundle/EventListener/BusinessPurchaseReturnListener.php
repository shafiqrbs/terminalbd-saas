...
class BusinessPurchaseReturnListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof BusinessPurchaseReturn) {
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('BusinessBundle:BusinessPurchaseReturn')->createQueryBuilder('s');
