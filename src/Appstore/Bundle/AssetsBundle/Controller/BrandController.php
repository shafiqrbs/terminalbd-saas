...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AssetsBundle:Brand')->findBy(array('config'=>$config),array('name'=>'asc'));
        return $this->render('AssetsBundle:Brand:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AssetsBundle:Brand:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AssetsBundle:Brand')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Brand entity.');
        }

       return $this->render('AssetsBundle:Brand:show.html.twig', array(
            'entity'      => $entity,
        ));
    }
    ...
    */
    ...
    public function autoSearchAction(Request $request)
    {
        ...
        if ($item) {
          ...
          $item = $this->getDoctrine()->getRepository('AssetsBundle:Brand')->searchAutoComplete($item,$config);
        }
