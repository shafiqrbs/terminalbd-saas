 ...
 * ItemImport
 *
 * @ORM\Table("assets_item_import")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\AssetsBundle\Repository\ItemImportRepository")
 */
class ItemImport
{
    /**
    ...
    /**
     * @param mixed $assetsConfig
     */
    public function setAssetsConfig($assetsConfig)
    {
