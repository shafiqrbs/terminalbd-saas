...
class AccountSalesAdjustmentListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof AccountSalesAdjustment) {
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('AccountingBundle:AccountSalesAdjustment')->createQueryBuilder('s');
        $qb
            ->select('MAX(s.code)')
