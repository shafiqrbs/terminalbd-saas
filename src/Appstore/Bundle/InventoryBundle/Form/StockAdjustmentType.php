...
class StockAdjustmentType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('item','text', array('attr'=>array('class'=>'m-wrap span12 selectAllItem input','placeholder'=>'Enter stock name'),
                'constraints' =>array(
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Appstore\Bundle\InventoryBundle\Entity\ItemStockAdjustment'
        ));
    }
