...
/**
 * ServiceItemController controller.
 *
 */
class ServiceItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('InventoryBundle:ServiceItem:index.html.twig', array(
    ...
    private function createCreateForm(PurchaseVendorItem $entity)
    {
        ...
        $form = $this->createForm(new ServiceItemType($em,$inventoryConfig), $entity, array(
