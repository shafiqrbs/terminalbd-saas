...
use Appstore\Bundle\DoctorPrescriptionBundle\Entity\DpsPurchase;
use Appstore\Bundle\DoctorPrescriptionBundle\Entity\DpsPurchaseItem;
...
/**
 * DpsPrescriptionFormatRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class DpsPrescriptionFormatRepository extends EntityRepository
{
    ...
    public function findDpsExistingCustomer($hospital, $mobile,$data)
    {
        ...
        $entity = $em->getRepository('DoctorPrescriptionBundle:Particular')->findOneBy(array('dmsConfig' => $hospital ,'service' => 6 ,'mobile' => $mobile));
        if($entity){
