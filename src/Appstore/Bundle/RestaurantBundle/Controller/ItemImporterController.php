...
use Appstore\Bundle\RestaurantBundle\Form\ItemImporterType;
...
class ItemImporterController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RestaurantBundle:ItemImport')->findBy(array('restaurantConfig'=>$config),array('updated'=>'DESC'));
        return $this->render('RestaurantBundle:ItemImporter:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('restaurant_itemimporter'));
        }
        return $this->render('RestaurantBundle:ItemImporter:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(ItemImport $entity)
    {
        ...
        $form = $this->createForm(new ItemImporterType($globalOption), $entity, array(
            'action' => $this->generateUrl('restaurant_itemimporter_create'),
            'method' => 'POST',
            'attr' => array(
    ...
    public function excelDataImportAction(ItemImport $ItemImporter)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $importer = $this->get('appstore_restaurant_item_import');
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('RestaurantBundle:ItemImport')->find($id);
    ...
    */
    private function createEditForm(ItemImport $entity)
    {
        $globalOption = $this->getUser()->getGlobalOption();
        $form = $this->createForm(new ItemImporterType($globalOption), $entity, array(
            'action' => $this->generateUrl('restaurant_itemimporter_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
        return $form;
    }
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            $em->flush();
            return $this->redirect($this->generateUrl('restaurant_itemimporter_edit', array('id' => $id)));
        }

        return $this->render('RestaurantBundle:ItemImporter:edit.html.twig', array(
            'entity'      => $entity,
            'edit_form'   => $editForm->createView(),
