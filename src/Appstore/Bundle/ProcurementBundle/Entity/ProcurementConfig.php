...
class ProcurementConfig
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Setting\Bundle\ToolBundle\Entity\GlobalOption", inversedBy="procurementConfig" , cascade={"persist", "remove"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\ProcurementBundle\Entity\PurchaseOrder", mappedBy="config" , cascade={"persist", "remove"})
     **/
