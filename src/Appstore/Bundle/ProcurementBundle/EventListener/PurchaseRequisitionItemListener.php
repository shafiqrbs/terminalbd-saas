...
class PurchaseRequisitionItemListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof PurchaseRequisitionItem) {
    ...
    public function getLastCode(LifecycleEventArgs $args,PurchaseItem $entity)
    {
        ...
        $qb = $entityManager->getRepository('ProcurementBundle:PurchaseRequisitionItem')->createQueryBuilder('s');
