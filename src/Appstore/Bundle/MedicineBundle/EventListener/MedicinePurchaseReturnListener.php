...
class MedicinePurchaseReturnListener
{
    ...
    public function createCode(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof MedicinePurchaseReturn) {
    ...
    public function getLastCode(LifecycleEventArgs $args, $datetime, $entity)
    {
        ...
        $qb = $entityManager->getRepository('MedicineBundle:MedicinePurchaseReturn')->createQueryBuilder('s');
